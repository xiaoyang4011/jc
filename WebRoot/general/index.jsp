...
<html>
<head>
<title>基础科学学院内容管理系统</title>
<jsp:include page="../inc.jsp"></jsp:include>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',href:'${pageContext.request.contextPath}/general/layout/north.jsp'" style="height: 50px;overflow: hidden;" ></div>
...
<div data-options="region:'east',title:'日历',split:true,href:'${pageContext.request.contextPath}/general/layout/east.jsp'" style="width: 200px;overflow: hidden;"></div>
	<div data-options="region:'center',title:'欢迎使用',href:'${pageContext.request.contextPath}/general/layout/center.jsp'" style="overflow: hidden;"></div>
